...
L=0.7 #m
coils=13
N_fit=np.array([300,300,270,270,250,230,200,200,170,170,150,150,100])
L_coil=0.05
R_coil=0.045/2
d_wire=0.005
b_wire=0.001
N_layer=L_coil/d_wire #=10 windings per layer
I_fit=np.array([19.0,19.0,18.745,17.932,18.074,18.943,19.0,19.0,19.0,18.116,17.275,14.26,16.774]) #A
