...
L=0.8 #m
coils=15
N_fit=np.array([300,300,270,270,250,250,230,200,200,170,170,150,150,150,100])
L_coil=0.05
R_coil=0.045/2
d_wire=0.005
b_wire=0.001
N_layer=L_coil/d_wire #=10 windings per layer
I_fit=np.array([22.0,22.0,22.0,21.223,21.568,20.718,21.687,22.0,22.0,22.0,22.0,21.141,18.848,15.277,16.954]) #A
