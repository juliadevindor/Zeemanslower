...
if __name__ == '__main__':
    ...
    Bfieldarray1 = np.linspace(0,1e-4,num=200) #np.linspace(0,-1e-4,num=300)
    Bfieldarray2 = np.linspace(1e-4,10e-4,num=100) #np.linspace(-1e-4,-10e-4,num=200)
    Bfieldarray3 = np.linspace(10e-4,0.5,num=100) #np.linspace(-10e-4,-0.5,num=100)
    ...
    for line_exc in range(num_lines_exc):
        for line_gs in range(num_lines_gs):
            ...
            for j in range(0,len(numberarray)):
                if j<3:
                    findpt_pos[0] = Position_B[0][line_exc][line_gs]
                    findpt_pos[1] = Position_B[1][line_exc][line_gs]
                    findpt_pos[2] = Position_B[2][line_exc][line_gs]
                    indexpt[0] = line_exc
                    indexpt[1] = line_exc
                    indexpt[2] = line_exc
                    steigung_pos = (findpt_pos[1] - findpt_pos[0]) / (numberarray[1] - numberarray[0])
                    findpt_neg[0] = Position_B[0][line_exc][line_gs]
                    findpt_neg[1] = Position_B[1][line_exc][line_gs]
                    findpt_neg[2] = Position_B[2][line_exc][line_gs]
                    steigung_neg = (findpt_neg[1] - findpt_neg[0]) / (numberarray[1] - numberarray[0])  ## 0 & 1
                ...
                if j>2:
                    steigung = (findpt[j-1]-findpt[0])/(numberarray[j-1]-numberarray[0])
