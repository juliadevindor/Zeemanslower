...
normal_slower_length=np.array([0.5,0.6,0.9,1.0])
normal_slower_length_ideal=np.array([0.5,0.6,0.7,0.8,0.9,1.0])
SF_slower_length=np.array([0.5,0.6,0.9,1.0])
...
allgs_dead_atom_ideal=np.array([98,38,87,150,146,178])
allgs_dead_atom_real=np.array([23,53,141,54])

allgs_slowed_atom_1_ideal=np.array([95,170,260,420,450,390])
allgs_slowed_atom_2_ideal=np.array([91,130+20,220,340,360,250])
allgs_slowed_atom_1_real=np.array([65,175,280,160])
allgs_slowed_atom_2_real=np.array([53,75,170,120])
