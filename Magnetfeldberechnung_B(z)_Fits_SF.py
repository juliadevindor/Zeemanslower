...
N_coil=np.array([320,270,270,260,260,250,250,240,230,210,190,170,160,140,130,130,200,250])
L_field=1.04 + dist#+time for increase of  magnetic field
num = 5000
...
popt, pcov = curve_fit(B_coil, xnew+0.5, ynew,method="trf",bounds=(-12,14))
...
with open("B(z)_0_9m_changed.txt","r") as g:
    ...
    ax.plot(x+0.5,y,label="CHANGED Decreasing field slower of length 0.5m")

file=open("B(z)_0_9m_SF_long.txt","w+")
for i in range(len(y)):
    file.write("{};{}\n".format(x[i], y[i]))
file.close()
