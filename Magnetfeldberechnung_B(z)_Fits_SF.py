...
N_coil=np.array([320,270,250,240,250,250,230,200,200,170,170,150,150,150,100,150])
L_field=0.93 + dist#+time for increase of  magnetic field
num = 5000
...
with open("B(z)_0_8m_changed.txt", "r") as g:  # plot measured magnetic field
    lines = g.readlines()
...
popt, pcov = curve_fit(B_coil, xnew+0.5, ynew,method="trf",bounds=(-20,14))
...
file=open("B(z)_0_8m_SF_long.txt","w+")
for i in range(len(y)):
    file.write("{};{}\n".format(x[i], y[i]))
file.close()
