...
with open("B(z)_0_5m_SF.txt","r") as g:
    ...
    ax.plot(x+0.5,y,color="blue",label="SF slower of length 0.5m")
...
with open("B(z)_0_6m_SF.txt","r") as g:
    ...
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
    ax.plot(x+0.5,y,color="orange",label="SF slower of length 0.6m")
...
with open("B(z)_0_7m_SF.txt","r") as g:
    ...
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
    ax.plot(x+0.5,y,color="green",label="SF slower of length 0.7m")
...
with open("B(z)_0_8m_SF.txt","r") as g:
    lines = g.readlines()
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
    ax.plot(x+0.5,y,color="red",label="SF slower of length 0.8m")
...
with open("B(z)_0_9m_SF.txt","r") as g:
    lines = g.readlines()
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
    ax.plot(x+0.5,y,color="purple",label="SF slower of length 0.9m")
...
with open("B(z)_1_0m_SF.txt","r") as g:
    ...
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
    ax.plot(x+0.5,y,color="brown",label="SF slower of length 1m")
...
with open("B(z)_fit_0_5m_SF.txt","r") as g:
    lines = g.readlines()
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
    ...
    print("L=", 0.5, "m: ", round(min(y), 3), round(x[np.argmin(y)] + 0.5, 3))
    print("L=",0.5,"m: ",round(x[np.argmin(y)] + 0.5, 3)-round(x[np.argmax(y)]+0.5,3))
with open("B(z)_fit_0_6m_SF.txt","r") as g:
    lines = g.readlines()
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
    ...
    print("L=", 0.6, "m: ", round(min(y), 3), round(x[np.argmin(y)] + 0.5, 3))
    print("L=",0.6,"m: ",round(x[np.argmin(y)] + 0.5, 3)-round(x[np.argmax(y)]+0.5,3))
with open("B(z)_fit_0_7m_SF.txt","r") as g:
    lines = g.readlines()
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
    ...
    print("L=", 0.7, "m: ", round(min(y), 3), round(x[np.argmin(y)] + 0.5, 3))
    print("L=",0.7,"m: ",round(x[np.argmin(y)] + 0.5, 3)-round(x[np.argmax(y)]+0.5,3))
with open("B(z)_fit_0_8m_SF.txt","r") as g:
    lines = g.readlines()
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
    ...
    print("L=", 0.8, "m: ", round(min(y), 3), round(x[np.argmin(y)] + 0.5, 3))
    print("L=",0.8,"m: ",round(x[np.argmin(y)] + 0.5, 3)-round(x[np.argmax(y)]+0.5,3))
with open("B(z)_fit_0_9m_SF.txt","r") as g:
    lines = g.readlines()
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
    ...
    print("L=", 0.9, "m: ", round(min(y), 3), round(x[np.argmin(y)] + 0.5, 3))
    print("L=",0.9,"m: ",round(x[np.argmin(y)] + 0.5, 3)-round(x[np.argmax(y)]+0.5,3))
with open("B(z)_fit_1_0m_SF.txt","r") as g:
    lines = g.readlines()
    x = np.asarray([float(line.split(";")[0]) for line in lines])
    y = np.asarray([float(line.split(";")[1]) for line in lines])
